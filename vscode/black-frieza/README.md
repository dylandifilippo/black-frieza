...
Select with `cmd-k cmd-t` after installing.
...
- **Zed**: [github.com/dylandifilippo/black-frieza](https://github.com/dylandifilippo/black-frieza)
- **Cursor / Windsurf / VSCodium**: via [Open VSX](https://open-vsx.org/extension/dylan-di-filippo/black-frieza-theme)
